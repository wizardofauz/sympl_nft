...
class TestNFT():
    ...
    def test_nft_life_cycle(self, nft):
        ...
        new_nft = nft.create_nft(name='SymNyan', symbol='~=[,,_,,]:3', owner_address='eth://sendmemoney')
    ...
    def test_can_mint(self, nft):
        new_nft = nft.create_nft(name='SymNyan v2', symbol='~=[,,,_,,,]:3', owner_address='eth://sendmemoney')
    ...
    def test_can_burn(self, nft):
        new_nft = nft.create_nft(name='SymNyan v3', symbol='~=[,,,,_,,,,]:3', owner_address='eth://sendmemoney')
    ...
    def test_cannot_overburn(self, nft):
        new_nft = nft.create_nft(name='SymNyan v4', symbol='~=[,,,,,_,,,,,]:3', owner_address='eth://sendmemoney')
